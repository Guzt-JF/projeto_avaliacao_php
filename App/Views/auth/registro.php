<div class="panel_main_container">
  <div class="panel_div">
    ...
    <span class="panel_title">Cadastrar Novo Usuário</span>

    <div class="panel_input_container" id="panel_username_container">
      <input class="panel_input" name="user" id="panel_username_input" type="text" placeholder="Nome de usuário"/>
    </div>

    <span class="panel_error_span" id="panel_error_username"></span>

    <div class="panel_input_container" id="panel_email_container">
      <input class="panel_input" name="email" id="panel_email_input" type="text" placeholder="email@email.com"/>
    </div>

    <span class="panel_error_span" id="panel_error_email"></span>

    <div class="panel_input_container" id="panel_password_container">
      <input class="panel_input"  name="password" id="panel_password_input" type="password" placeholder="••••••••••"/>
    ...
    <div class="panel_buttons">
      <button class="panel_button" id="panel_sign_up">
        <div id="panel_loading_span" class="panel_loading loading d-none"></div>
        <span id="panel_sign_up_span" class="panel_span">Cadastrar</span>
      </button>
      <a class="panel_a" href="<?= BASE_URL ?>/auth">Entrar na conta</a>
    </div>
  </div>
</div>